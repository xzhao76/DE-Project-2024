...
variables:
  ...
  staging_table: "public.{{inputs.taxi}}_tripdata_{{trigger.date | date('yyyy_MM')}}"
  ...
  - id: if_yellow
    ...
    then:
        - id: yellow_create_table
          ...
          type: io.kestra.plugin.jdbc.postgresql.Queries
          sql: CREATE TABLE IF NOT EXISTS {{render(vars.table)}} (
                unique_row_id          text,
                filename               text,
                VendorID               text,
